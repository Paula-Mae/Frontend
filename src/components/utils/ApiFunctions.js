...
export const api = axios.create({
	baseURL: "https://ws101-lantaran-grove-white-beach-resort-backend-production.up.railway.app"
})
...
// NEW: Header for multipart/form-data (file uploads)
...
export async function addRoom(photo, roomType, roomPrice) {
	...
	const response = await api.post("/rooms/add/new-room", formData, {
		headers: getHeaderMultipart() // FIXED: Use multipart headers
	})
